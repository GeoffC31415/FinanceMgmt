...
const COLUMN_GROUPS: ColGroup[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { header: "Pension AA Charge", key: "pension_annual_allowance_charge_median", format: "currency" },
      { header: "Pension Tax-Free Remaining", key: "pension_tax_free_cash_remaining_median", format: "currency" },
      { header: "Pension Tax-Free Taken", key: "pension_tax_free_cash_taken_median", format: "currency" },
      { header: "Pension MPAA Active", key: "pension_mpaa_active_median", format: "number" },
      { header: "Pension AA", key: "pension_annual_allowance_median", format: "currency" },
      { header: "Pension Is Tapered", key: "pension_is_tapered_median", format: "number" },
      { header: "Pension Tapered AA", key: "pension_tapered_allowance_median", format: "currency" },
