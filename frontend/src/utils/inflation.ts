...
export function applyInflationAdjustment(
  ...
  return {
    ...
    asset_funding_cash_median: adjust(result.asset_funding_cash_median),
    asset_funding_isa_median: adjust(result.asset_funding_isa_median),
    asset_funding_gia_median: adjust(result.asset_funding_gia_median),
    asset_funding_pension_median: adjust(result.asset_funding_pension_median),
    asset_funding_property_median: adjust(result.asset_funding_property_median),
