...
describe("applyInflationAdjustment", () => {
  ...
  function makeResponse(
    ...
    return {
      ...
      asset_funding_cash_median: Array.from({ length: n }, () => 0),
      asset_funding_isa_median: Array.from({ length: n }, () => 0),
      asset_funding_gia_median: Array.from({ length: n }, () => 0),
      asset_funding_pension_median: Array.from({ length: n }, () => 0),
      asset_funding_property_median: Array.from({ length: n }, () => 0),
