...
function makeMockResponse() {
  return {
    ...
    asset_funding_cash_median: [0, 0, 0],
    asset_funding_isa_median: [0, 0, 0],
    asset_funding_gia_median: [0, 0, 0],
    asset_funding_pension_median: [0, 0, 0],
    asset_funding_property_median: [0, 0, 0],
